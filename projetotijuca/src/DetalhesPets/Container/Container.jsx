        ...
        <div className="descrição_animal">
          <div>
            ...
            <span className="span_descrição">
              Esse é o chiquinho irmão do kiwi e da amora, filhote da gatinha
              grávida que resgatei, ele com toda certeza é o mais manhoso da
              ninhada e comilão, é muito sociável e ama brincar.
            </span>
          </div>
